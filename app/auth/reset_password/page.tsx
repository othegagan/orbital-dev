...
export default function ResetPasswordPage() {
    ...
    useEffect(() => {
        ...
        const storedOTP = localStorage.getItem('Username');
        const storedMobileOTP = localStorage.getItem('phoneNo');
        //
        if (storedMobileOTP) {
    ...
    //Reset Password
    async function onResetClick(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            const response = await fetch('https://orbitalwebapi-stagging.azurewebsites.net/api/User/ResetPassword', {
                method: 'POST',
                headers: {
                ...
                <div className='mx-auto max-w-2xl'>
                    <div className='relative mt-5 items-center  justify-center rounded-sm border bg-white p-4 dark:border-neutral-700 dark:bg-neutral-900 sm:mt-10 md:p-10'>
                        ...
                        <div className='mb-5 text-center sm:mb-5'>
                            <h1 className='mb-2 block text-2xl font-bold text-[#000000] dark:text-white sm:mb-2'>Reset Password</h1>
                        </div>
