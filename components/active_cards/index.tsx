...
const ActiveCardsDetailsPage = () => {
    ...
    async function GetCardDetails(userIdValue: string | number | boolean) {
        try {
            ...
            const url = `https://orbitalwebapi-stagging.azurewebsites.net/api/Dashboard/GetPlaidBankAccountList?${queryString}`;
                                        ...
                                        <div className='pt-4 sm:pt-6'>
                                            <div className='flex items-end justify-between'>
                                                <div className=''>
                                                    ...
                                                    <p className='text-base font-bold tracking-widest'>{account?.availableBalance || 0}</p>
                                                </div>
                                                <div className=''>
                                                        ...
                                                        <div className='grid gap-4'>
                                                            ...
                                                            <div className='grid gap-2  text-sm capitalize'>
                                                                ...
                                                                <div className='grid grid-cols-2 items-center gap-4'>
                                                                    ...
                                                                    <p>{account?.availableBalance || 0}</p>
                                                                </div>
                                                                <div className='grid grid-cols-2 items-center gap-4'>
                                                                    <Label className='font-semibold'>Current Balance : </Label>
                                                                    <p>{account?.currentBalance || 0}</p>
                                                                </div>
                                                                <div className='grid grid-cols-2 items-center gap-4'>
